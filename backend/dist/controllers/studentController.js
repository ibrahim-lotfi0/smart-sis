...
exports.getMyRiskFactors = exports.registerCourse = exports.getFeedbackHistory = exports.submitFeedback = exports.getStudentExams = exports.getStudentSchedule = exports.getStudentCourses = exports.getStudentAttendance = exports.getStudentGrades = exports.getStudentProfile = void 0;
...
const submitFeedback = async (req, res) => {
    try {
        ...
        // 3. Save to DB
        await pool.request()
            .input('studentId', db_1.sql.Int, studentId)
            .input('courseId', db_1.sql.Int, parseInt(courseId))
            .input('feedbackText', db_1.sql.NVarChar(2000), feedbackText.trim())
            .input('sentiment', db_1.sql.NVarChar(10), sentiment)
            .query(`
...
const registerCourse = async (req, res) => {
    try {
        ...
        const check = await pool.request()
            .input('userId', db_1.sql.Int, req.user.userId)
            .input('courseId', db_1.sql.Int, courseIdParsed)
            .input('semId', db_1.sql.Int, semesterId)
...
const getMyRiskFactors = async (req, res) => {
    try {
        const pool = await db_1.poolPromise;
        const userId = req.user.userId;
        // Fetch Attendance Rate
        const attRes = await pool.request()
            .input('uid', db_1.sql.Int, userId)
...
exports.getMyRiskFactors = getMyRiskFactors;
